...
func TestUnmarshal(t *testing.T) {
	...
	if e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].PhaseHint != "P" {
		t.Error("Pick.PhaseHint expected 1.532535963, got ", e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].PhaseHint)
	}
	if e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].WaveformID.NetworkCode != "NZ" {
		t.Error("Pick.WaveformID.NetworkCode expected NZ, got ",
			e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].WaveformID.NetworkCode)
	}
	if e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].WaveformID.StationCode != "WVZ" {
		t.Error("Pick.WaveformID.StationCode expected WVZ, got ",
			e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].WaveformID.StationCode)
	}
	if e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].WaveformID.LocationCode != "10" {
		t.Error("Pick.WaveformID.LocationCode expected 10, got ",
			e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].WaveformID.LocationCode)
	}
	if e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].WaveformID.ChannelCode != "HHZ" {
		t.Error("Pick.WaveformID.ChannelCode expected HHZ, got ",
			e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].WaveformID.ChannelCode)
	}
	if e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].EvaluationMode != "automatic" {
		t.Error("Pick.EvaluationMode expected automatic, got ",
			e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].EvaluationMode)
	}

	pt, _ := time.Parse(time.RFC3339Nano, "2012-01-27T04:06:29.798393Z")
	if e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].Time.Value != pt {
		t.Error("Pick.Time.Value expected 2012-01-27T04:06:29.798393Z, got ", e.Picks["smi:scs/0.7/20120127.040629.79-AIC-NZ.WVZ.10.HHZ"].Time)
	}
